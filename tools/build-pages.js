/* =============================================================================
   ...
   Пишет: events/, books/, video/, bio/ — страницу раздела и страницы
...
written.push(write('video/index.html', videoSectionPage({
  title: 'Телепередачи',
  description: 'Телепередачи, беседы и лекции архимандрита Мелхиседека (Артюхина): запись и расшифровка эфира.',
  items: VIDEO,
})));
